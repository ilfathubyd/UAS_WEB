...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <!-- body -->
            <form action="/storeProductAdmin" method="post" enctype="multipart/form-data">
                @csrf
                <!-- form fields -->
                <div class="mb-3">
                    <label for="exampleInputText" class="form-label">Nama Produk</label>
                    <input type="text" class="form-control" id="namaProduk" name="namaProduk" aria-describedby="emailHelp" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="stok" name="stok" aria-describedby="emailHelp" required>

    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container bg-info pt-3 pb-3 mt-1 rounded w-75">
                <h4 class="text-center text-light">Tabel Penjualan</h4>
                <a href="/createProductAdmin" class="btn btn-primary mb-3"><i class="fas fa-user-plus"></i> Tambah</a>
                <table id="tabel" class="table table-bordered table-striped table-light pt-3">
                    ...
                    <tbody>
                        @foreach ($display as $dis => $dt)
                            <tr>
                                <td>{{ $loop->iteration }}</td>
                                <td>{{ $dt->id_item }}</td>
                                <td>{{ $dt->item }}</td>
                                <td>{{ $dt->total }}</td>
                                <td>Rp{{ number_format($dt->harga, 3, ',', '.') }}</td>
                                <td>
                                    <form action="{{ route('ubahAdminProduct') }}" method="GET">                                    

...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/transaksiPengguna">
                    <i class="fs-4 bi-credit-card-2-front-fill"></i>
                    ...
                    <table id="tabel" class="table table-bordered table-striped table-light pt-3">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $dt->namaProduk }}</td>
                                <td><img src="{{ asset('gambarProduk/'.$dt->gambarProduk) }}" alt="" style="width: 150px;"></td>
                                <td>{{ $dt->stok }}</td>
                                <td>{{ $dt->harga }}</td>
                            </tr>
                            @endforeach

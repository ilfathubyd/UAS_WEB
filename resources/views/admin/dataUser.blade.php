...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <br>
            <!-- Main Content -->
            <div class="ms-5 px-3 py-3 bg-primary w-25 rounded-3">
                <h1 class="text-light">{{$jumlah_user}}</h1>
                <h4 class="text-light">Pengguna Terdaftar</h4>
                <a href="/detailUser" class="btn btn-light">Lihat Data Pengguna</a>
            </div>
            <!-- End of Main Content -->
